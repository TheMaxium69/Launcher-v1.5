			      ...
			      System.out.println("----------|BASE DONNER [GOOD]|----------");
				      ...
				      try {
					      ...
					      if (result.next() == true) {
					    	  ...
					    	  JOptionPane.showMessageDialog(this,  "Votre email "+ email +" n'est pas dans notre base de donné");
								setFieldsEnabled(true);
								return;
					      }
				    	  ...
				    	  JOptionPane.showMessageDialog(this,  "Une erreur de requete entre votre ordinateur et notre base de donné est survenu");
							setFieldsEnabled(true);
							return;
				      }
				      ...
				      JOptionPane.showMessageDialog(this,  "Une erreur entre votre ordinateur et notre base de donné est survenu");
						setFieldsEnabled(true);
						return;
				    }	  
		}
